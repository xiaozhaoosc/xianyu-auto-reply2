...
import { getRateBatchDetail, type RateBatchDetail, type RateLog } from '@/api/rateLogs'
import {
  BatchLogDetail,
  renderAccountIdCell,
  renderDateTimeText,
...
const summaryCards: BatchLogSummaryCard<RateBatchDetail>[] = [
  {
    icon: Star,
...
const columns: BatchLogTableColumn<RateLog>[] = [
...
export function RateBatchDetailPage() {
  return (
    <BatchLogDetail<RateBatchDetail, RateLog>
      fetchDetail={getRateBatchDetail}
      backPath="/admin/rate-batches"
