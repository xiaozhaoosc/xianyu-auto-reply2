 ...
 * 功能：
 * 1. 显示微信公众号二维码图片
 * 2. 提示用户关注公众号"执念商业"发送"最新源码"获取最新源码
 * 3. 支持点击放大预览二维码图片
 */
      ...
      <div className="pt-20 pb-10 px-4 sm:px-6 flex items-start justify-center min-h-screen">
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">最新源码</h1>
            ...
            <div className="flex flex-col items-center">
              ...
              <div
                className="w-[200px] h-[200px] overflow-hidden rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer
                           transition-all duration-200 hover:scale-105 hover:shadow-lg hover:border-green-400 dark:hover:border-green-500"
              ...
              <div className="mt-6 text-center space-y-3">
                <p className="text-base font-medium text-slate-900 dark:text-white">
                  微信公众号：<span className="text-green-600 dark:text-green-400">执念商业</span>
                </p>
                <div className="bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-800 p-4">
                  <p className="text-sm text-green-700 dark:text-green-300">
                    关注微信公众号 <span className="font-bold">"执念商业"</span>
                  </p>
                  <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                    发送 <span className="font-bold bg-green-100 dark:bg-green-800/50 px-1.5 py-0.5 rounded">"最新源码"</span> 获取最新源码
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 w-full">
                <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4 space-y-2">
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    <span className="font-medium text-slate-700 dark:text-slate-300">源码特点：</span>
                    完整项目源码，可自由部署和二次开发
                  </p>
                  <p className="text-xs text-slate-500 dark:text-slate-400">
